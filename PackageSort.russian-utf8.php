<?php
// Version: 1.1: PackageSort.russian.php
...
$txt['pkgstatehelp_cannot_uninstall'] = 'Эти моды не могут быть установлены на текущую версию SMF. Вы можете попробовать связаться с автором каждого мода и попросить его обновить свой продукт для поддержки последней версии SMF.';
